...
import {ButtonDemo} from "../primaryButton";
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 bg-black md:py-40 px-4 w-full  left-0 top-0" >
      <h1 className="text-2xl md:text-7xl font-bold text-white dark:text-white">
      Transform Your Brand <br /> with AI generated Models
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200 dark:text-neutral-200">
      Generate professional model photos for your products in seconds. Just upload a dress and background, and let our AI do the rest.
      </p>
